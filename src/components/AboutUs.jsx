...
import history from "../assets/aboutus/history.jpg";
import culture from "../assets/aboutus/culture.jpg";

import CEO from "../assets/teams/ceo.png";
import designer from "../assets/teams/designer.png";
    ...
    <div>
      ...
      <div className="">
        <div className="max-w-3xl mx-auto mb-24">
          <h1 className="mt-20 text-center text-4xl font-semibold">WE CREATE MODERN, INDIVIDUAL LUXURY.</h1>
          <p className="text-center mt-7 leading-7">
        ...
        <section id="history">
          <h2 className="mb-5 text-center text-4xl font-medium">THE HISTORY OF BRABUS</h2>
          <p className="max-w-4xl mx-auto">
            ...
            <br />
            <img className="w-[50%] mx-auto py-5" src={history} alt="" />
            <br />
        ...
        <section id="meetTeam">
          <h2 className="mb-5 text-center text-4xl font-medium mt-20">Meet the Driving Force: The Brabus Team</h2>
          <div className="flex flex-wrap gap-10 max-w-4xl justify-center mx-auto ">
            <div className="w-64 pb-5">
              ...
              <p className="text-justify">
                Experience: With a lifelong passion for high-performance vehicles, Cameron Deatsch has been a driving force in the automotive industry for over 15 years. Their visionary leadership has shaped Brabus into a symbol of
            ...
            <div className="w-64">
              ...
              <p className="text-justify">
                Experience: A maestro in crafting compelling narratives, Zeynep Ozdemir brings over 7 years of experience in the automotive marketing landscape. Their strategic vision has elevated Brabus's brand presence, creating a
                powerful resonance in the hearts of enthusiasts globally.
              </p>
            </div>
            <div className="w-64">
              ...
              <p className="text-justify">
                Experience: At the helm of the production division, [Production Director's Name] oversees the intricate process of bringing supercars to life. With [X] years of experience in high-end automotive manufacturing, they ensure
                that precision and quality define every step of the production journey.
              </p>
            </div>
            <div className="w-64">
              ...
              <p className="text-justify">
                Experience: With a background in supercar engineering, Mike Cannon-Brookes leads our powertrain team, ensuring that every supercar boasts not only breathtaking design but also state-of-the-art engineering. Their 10 years of
                experience contribute to the innovation and performance that define Brabus Company.
              </p>
            </div>
            <div className="w-64">
              ...
              <p className="text-justify">
                Experience: As the creative genius behind the aesthetic appeal of our supercars, Scott Farquhar brings over 5 years of experience in automotive design. Their portfolio includes iconic designs that have set new standards in
                the world of luxury and performance.
              </p>
            </div>
          </div>
        </section>
        <section id="culture" className="mt-20 mb-24">
          <h2 className="mb-5 text-center text-4xl font-medium">BRABUS CULTURE</h2>
          <img alt="" />
          <div className="max-w-4xl mx-auto mb-7">
            <h3 className="py-2 text-xl font-medium mb-2">Empathy and Collaboration</h3>
            <p>
              <strong>Kindness:</strong> In the world of high-performance vehicles, our culture begins with kindness. We empathize with each team member, valuing their perspectives regardless of hierarchy. Whether working with colleagues or
              supporting our students on their journey, we prioritize compassion and understanding. <br />
              <br />
              <b>Collaborative Compassion:</b> Hierarchies hold no sway in our commitment to empathy. From team members to managers, we foster a culture where everyone's voice is heard and valued. Our empathy extends beyond the workshop,
              resonating with the dreams and anxieties of our students as they embark on their supercar experience.
            </p>
          </div>
          <img className="w-[50%] mx-auto py-5" src={culture} alt="" />
          <div className="max-w-4xl mx-auto mb-7">
            <h3 className="py-2 text-xl font-medium mb-2">Transparency and Authenticity</h3>
            <p>
              <strong>Candor and Openness:</strong> Just as the sleek lines of our supercars are transparent in design, so too is our communication. We promote candor horizontally among teams, downward from management, and upward from team
              ...
              <br />
              <br />
              <b>Feedback-Driven Culture:</b> Constructive feedback is the engine that propels us forward. Seeking feedback is not a weakness; it's a strength. We encourage open dialogue to fuel innovation and growth, ensuring every member
              has a voice in shaping our collective success.
            </p>
          </div>
          <div className="max-w-4xl mx-auto mb-7">
            <h3 className="py-2 text-xl font-medium mb-2">Uncompromising Standards</h3>
            <p>
              <strong>Commitment to Excellence:</strong> In the words of Walt Disney, "Around here, we try to be proud of every little piece of work we do." This sentiment echoes through every aspect of Brabus. Upholding the highest
              ...
              <br />
              <b>Shared Responsibility:</b> We don't just expect excellence from ourselves; we expect it from our colleagues, direct reports, and peers. By setting the bar high, we create a culture where exceptional performance becomes the
              norm.
            </p>
          </div>
        </section>
