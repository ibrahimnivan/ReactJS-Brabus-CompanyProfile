    ...
    <div>
      ...
      <div id="videotron" className="w-full relative">
        ...
        <div className="h-[8vh] flex justify-center items-center gap-20 border-b-2">
          <a className="py-2 px-4 block font-medium text-lg hover:bg-slate-200" href="#company-overview">OVERVIEW</a>
          <a className="py-2 px-4 block font-medium text-lg hover:bg-slate-200" href="#signature">SIGNATURE</a>
          <a className="py-2 px-4 block font-medium text-lg hover:bg-slate-200" href="#products">SUPERCARS</a>
          <a className="py-2 px-4 block font-medium text-lg hover:bg-slate-200" href="#media-review">MEDIA REVIEW</a>
        </div>
      </div>
      <section id="company-overview" className="mx-auto">
        <h2 className="text-center mt-16 pt-5 mb-12 text-3xl">UNLEASH THE BEAST | BRABUS OVERVIEW</h2>
        <div id="overview-grid" className="mx-auto">
          ...
          <div id="history" className="max-w-3xl mx-auto mt-6 mb-10">
            ...
            <p className="text-justify">
              The company name was derived from the first three characters of the founders' surnames (<strong>Bra</strong>ckmann, <strong>Bus</strong>chmann). The company began with Bodo Buschmann wanting to customise his cars. Discovering most existing customisers could
              not grasp his vision or meet his requirements, he started his own brand. Brabus GmbH was registered in 1977 in West Germany with Buschmann's friend Klaus Brackmann to satisfy German law requiring a company to be established
          ...
          <div id="signature" className="bg-black text-gray-200 py-12">
            <div id="principles" className="">
              ...
              <div className="grid grid-cols-3 justify-items-center max-w-5xl mx-auto">
            ...
            <div id="services" className="mt-16 max-w-3xl mx-auto pb-10">
              ...
              <table class="min-w-full a">
                <tbody class="">
                  <tr className="">
                    <td class="px-6 py-2 align-text-top text-orange-800">Performance Tuning :</td>
                    <td class="px-6 py-2 align-text-top">Unleash the full potential of your vehicle with our expertly crafted performance tuning packages.</td>
                  </tr>

                  <tr>
                    <td class="px-6 py-2 align-text-top text-orange-800">Aesthetic Enhancements :</td>
                    <td class="px-6 py-2 align-text-top">Elevate the visual appeal of your car with our custom body kits, wheels, and interior upgrades.</td>
                  </tr>

                  <tr>
                    <td class="px-6 py-2 align-text-top text-orange-800">Exclusive Editions :</td>
                    <td class="px-6 py-2 align-text-top">Experience automotive luxury like never before with our limited-edition models, each a masterpiece in its own right.</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section id="media-review" className="bg-testimonials-background">
        <h2 className="text-center pt-24  text-4xl">MEDIA REVIEW</h2>
        ...
        <div id="cards" className="flex flex-row mt-36 justify-center gap-5 pb-24">
          <div id="card" className="w-[350px]  text-center bg-[#e9ecef] bg-opacity-75">
            ...
            <p className="px-6 pb-6">In their latest review, Car and Driver Magazine showers praise on the Brabus 900 NLP 6x6 for its exceptional blend of power and refinement. The nimble handling and robust acceleration drew high praise, turning every drive into an exhilarating experience. The tech-savvy features, including  comprehensive driver-assistance suite, left the reviewers thoroughly impressed. Car and Driver concludes that the Brabus 900 NLP 6x6 isn't just a car; it's a driving revelation, setting a thrilling standard for the modern, tech-forward enthusiast.</p>
          </div>
          <div id="card" className="w-[350px]  text-center bg-[#e9ecef] bg-opacity-75">
            <img className="w-32 mx-auto py-4" src={topGear} alt="" /> 
            <p className="px-6 pb-6">TopGear Magazine's latest review of the 900 R is nothing short of a love letter to automotive excellence. The editors are raving about the jaw-dropping performance, describing the engine's roar as a symphony of power. The cutting-edge technology leaves them spellbound, TopGear's verdict? 900 R is not just a car; it's a masterpiece on wheels, setting a new standard for performance and sophistication in the automotive world</p>
          </div>
          <div id="card" className="w-[350px]  text-center bg-[#e9ecef] bg-opacity-75">
            <img className="w-32 mx-auto py-4" src={motorTrend} alt="" /> 
            <p className="px-6 pb-6">MotorTrend Magazine is giving the praises of the Brabus 750 Bodo Buschmann Edition, declaring it a triumph in automotive engineering. The review emphasizes the Brabus 750 Bodo Buschmann Edition's blistering performance, with the roaring engine and precise handling turning every drive into a visceral adventure. The striking design doesn't just turn heads; it demands a second look. MotorTrend Magazine concludes that the Bodo Buschmann Edition ignites thrilling benchmark for performance enthusiasts.</p>
          </div>
        </div>
      </section>
      <section id="products">
