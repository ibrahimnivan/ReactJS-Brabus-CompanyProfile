        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
          <div id="grid1" className="w-[85%] xl:border-none border-b-2 border-gray-600 pb-3">
            <div className="flex flex-col justify-center items-center">
              <Link to="/ourteam" className="block hover:text-orange-500 text-base xl:text-lg mb-4">OUR TEAM</Link>
              <a className="block hover:text-orange-500 text-base xl:text-lg mb-4">PRIVACY POLICY</a>
              <a className="block hover:text-orange-500 text-base xl:text-lg mb-4">COOKIE SETTINGS</a>
            </div>
            <div className="">
              <a
         ...
         items-center border border-slate-300 text-gray-200 hover:bg-orange-500"
          ...
          <div id="grid2" className="w-[85%] xl:border-none border-b-2 border-gray-600 pb-3">
            <div className="flex flex-col justify-center items-center">
              <Link to="/about" className="block hover:text-orange-500 text-base xl:text-lg mb-4">ABOUT US</Link>
              <a className="block hover:text-orange-500 text-base xl:text-lg mb-4">FIND A DEALER</a>
              <a className="block hover:text-orange-500 text-base xl:text-lg mb-4">CAREER</a>
            </div>
            <div className="">
              <a
         ...
         items-center border border-slate-300 text-gray-200 hover:bg-orange-500"
          ...
          <div id="grid3" className="w-[85%] xl:border-none border-b-2 border-gray-600 pb-3">
            <div className="flex flex-col justify-center items-center">
              <a className="block hover:text-orange-500 text-base xl:text-lg mb-4">CONTACT</a>
              <a className="block hover:text-orange-500 text-base xl:text-lg mb-4">LOG IN</a>
              <a className="block hover:text-orange-500 text-base xl:text-lg mb-4">LATEST NEWS</a>
            </div>
            <div className="">
              <a
